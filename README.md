...
**MyNYTimes** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
1. Use of Retrofit 2 and to make it extensible to consume various REST API's.
2. To update the UI and to keep the Application consistent based on user preference changes.
3. To enable endless scrolling with retrofit and handle custom retry logic to fetch results from the API.
